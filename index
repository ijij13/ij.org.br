...
<body>
    <header>
        <h1>Instituto IJ</h1>
        <p>Transformando Vidas através da Educação e Inovação</p>
    </header>
    <nav>
        <button onclick="scrollToSection('sobre')">Sobre Nós</button>
        <button onclick="scrollToSection('projetos')">Projetos</button>
        <button onclick="scrollToSection('contato')">Entre em Contato</button>
    </nav>
    <main>
        <section id="sobre">
            <h2>Sobre Nós</h2>
        ...
        <section id="contato">
            ...
            <form action="mailto:parcerias@ij.org.br" method="post" enctype="text/plain">
                <div>
